        ...
        if self.enabled {
            ...
            if self.use_trailing {
                ...
                if self.trailing_distance >= self.default_percent {
                    anyhow::bail!("stop_loss trailing_distance should be less than default_percent");
                }
            }
        }
        ...
        if self.enabled {
            ...
            if self.use_partial {
                ...
                if self.first_partial_level >= self.default_percent {
                    anyhow::bail!("take_profit first_partial_level should be less than default_percent");
                }
            }
        }
