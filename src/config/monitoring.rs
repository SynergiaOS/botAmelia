...
impl RetentionConfig {
    ...
    pub fn validate(&self) -> Result<()> {
        ...
        if self.medium_resolution_days < self.high_resolution_days {
            anyhow::bail!("medium_resolution_days must be greater than or equal to high_resolution_days");
        }
        
        if self.low_resolution_days < self.medium_resolution_days {
            anyhow::bail!("low_resolution_days must be greater than or equal to medium_resolution_days");
        }
